...
<img src="/assets/img/zonas_trabajo.png" width="800px">
...
1. **Cubo "Hola Mundo"**
    ...
    **Procedimiento:**
    ...
    <img src="/assets/img/bloque_cubo.png" width="40%"> y lo llevamos a la zona del programa.
    ...
    <img src="/assets/img/cube10x10x10c.png" width="80%">
    ...
    **Ejemplos:**
    ...
    | Bloque | Renderizado |
    |:------:|:-----------:|
    |<img src="/assets/img/bloque01.png"> |<img src="/assets/img/cube10x20x30nc.png"> |
    |<img src="/assets/img/bloque02.png"> |<img src="/assets/img/cube10x20x30c.png"> |
    |<img src="/assets/img/bloque03.png"> |<img src="/assets/img/cube10x10x10c.png"> |
    ...
    **Ejercicios:**
    ...
    |:--------:|:--------:|:--------:|
    | Modela un cubo de 2cm x 5cm x 3cm centrado |<img src="/assets/img/ejercicio01.png"> |[Solución](/assets/code/ejercicio01.xml)|
    | Modela un cubo de 6cm x 2cm x 3cm sin centrar|<img src="/assets/img/ejercicio02.png"> |[Solución](/assets/code/ejercicio02.xml)|
...
2. **Otros objetos primitivos: Cilindros y esferas**
    ...
    **Esferas:**  Para crear una esfera tendremos que seguir el siguiente procedimiento: Dentro del bloque *3D Shapes*, arrastramos el bloque 
    <img src="/assets/img/bloque_esfera.png" width="30%"> y lo llevamos a la zona del programa.
    
    Al renderizar obtendremos una esfera de *10mm*:
    
    <img src="/assets/img/esfera10.png" width="80%">
    ...
    **Cilindros:**  Para crear un cilindro tendremos que seguir el siguiente procedimiento: Dentro del bloque *3D Shapes*, arrastramos el bloque. 
    <img src="/assets/img/bloque_cilindro.png" width="600%"> y lo llevamos a la zona del programa. 
    ...
    <img src="/assets/img/cilindro10_10.png" width="80%">
    ...
    **Ejemplos:**
    ...
    | Bloque | Renderizado |
    |:------:|:-----------:|
    |<img src="/assets/img/bloque11.png"> |<img src="/assets/img/cilindro5_5_10c.png"> |
    |<img src="/assets/img/bloque12.png"> |<img src="/assets/img/tronco10_5_20nc.png"> |
    |<img src="/assets/img/bloque13.png"> |<img src="/assets/img/cono10_20nc.png"> |
    ...
    **Ejercicios:**
    ...
    | Problema | Imagen   | Solución |
    |:--------:|:--------:|:--------:|
    | Modela una esfera de 2cm |<img src="/assets/img/ejercicio11.png"> |[Solución](/assets/code/ejercicio11.xml)|
    | Modela un cilindro de 6cm de radio x 3cm de altura, sin centrar|<img src="/assets/img/ejercicio12.png"> |[Solución](/assets/code/ejercicio12.xml)|
    | Modela un cono de 3cm de base x 5cm de altura sin centrar|<img src="/assets/img/ejercicio13.png"> |[Solución](/assets/code/ejercicio13.xml)|
...
3.  **Transformaciones**
    ...
    **Traslaciones:**  Cuando *renderizamos* una de las primitivas anteriores, éstas aparecen colocadas en el centro de coordenadas. Mediante las traslaciones podemos desplazarlas a cualquirr lugar del espacio usando *vectores de posición*. Para trasladarun objeto tendremos que seguir el siguiente procedimiento: Dentro del bloque *3D Shapes*, arrastramos el bloque 
    <img src="/assets/img/bloque_traslacion.png" width="30%"> y lo llevamos a la zona del programa. Una vez ahí, colocamos dentro, arrastrando, los bloques correspondientes al objeto a trasladar.
    ...
    **Rotaciones:**  Para rotar un objeto, arrastramos el bloque    
    <img src="/assets/img/bloque_rotacion.png" width="30%"> y lo llevamos a la zona del programa. Una vez ahí, colocamos dentro, arrastrando, los bloques correspondientes al objeto a rotar. 
    ...
    **Ejemplos:**
    ...
    |:-------:|:------:|:-----------:|
    |Prisma de 10x20x30 centrado y trasladado 30 en la dirección X, 30 en la Y y 40 en la Z |<img src="/assets/img/bloque21.png"> |<img src="/assets/img/traslacion1.png"> |
    |Ejercicio anterior rotado 45º en el eje X |<img src="/assets/img/bloque22.png"> |<img src="/assets/img/rotacion1.png"> |
    ...
    **Ejercicios:**
    ...
    | Problema | Imagen   | Solución |
    |:--------:|:--------:|:--------:|
    | Modela un prisma de 10x0x10 trasladado 10 en el eje X|<img src="/assets/img/ejercicio21.png"> |[Solución](/assets/code/ejercicio21.xml)|
    | Modela un prisma de 10x0x10 rotado 45º sobre el eje z y trasladado 10 sobre el eje Y|<img src="/assets/img/ejercicio22.png"> |[Solución](/assets/code/ejercicio22.xml)|
...
4.  **Operaciones lógicas: Unión y Diferencia. Uniendo objetos y haciendo agujeros**
    ...
    **Uniones:** Para unir dos o más objetos tenemos que seleccionar el bloque <img src="/assets/img/bloque_union.png" width="30%">. En el bloque vemos que hay espacio para colocar dos sub-bloques, correspondientes a los objetos que queramos unir. Si queremos unir más de un objeto, pinchado en el símbolo +, podremos añadir espacio para nuevos sub-bloques.
    ...
    **Ejemplos:**
    ...
    | Ejemplo | Bloque | Renderizado |
    |:-------:|:------:|:-----------:|
    |Une un cubo de 10x10x10 con una esfera de radio 5 y trasladada 5 sobre el eje z|<img src="/assets/img/bloque31.png"> |<img src="/assets/img/ejemplo31.png"> |
    |Ejercicio anterior pero haciendo la diferencia entre el cubo y la esfera |<img src="/assets/img/bloque32.png"> |<img src="/assets/img/ejemplo32.png"> |
    
    **Ejercicio:**
    
    | Problema | Imagen   | Solución |
    |:--------:|:--------:|:--------:|
    | Modela un spinner de dos ramas con tres agujeros para cilindros de radio 11mm y 7 mm de altura|<img src="/assets/img/ejercicio31.png"> ||
...
![](/assets/img/attribution-share-alike-creative-commons-license.png)  
